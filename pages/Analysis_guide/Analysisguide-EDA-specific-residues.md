...
As mentioned [earlier](Analysisguide-plotting-RMSD-averages.html),
R is a programming language that is often used for data processing and
statistics.
The following script has been created to process through replicate EDA data and
obtain the averages for a system.

## `rmagic-EDA-avg.r` {#rmagic-EDA-avg}
```R
